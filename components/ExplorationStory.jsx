...
const ExplorationStory = ({ onBack }) => {
  ...
  const scenes = {
    ...
    leave_entirely: {
      ...
      text: "You leave the expedition entirely. No imprisonment, no conflict—you simply walk away. Cortés lets you go, glad to be rid of a problematic translator.\n\nYou settle in a small coastal village, far from conquest's front lines. You teach languages, work as a scribe, help with translations for trade. It's quiet, modest work.",
      isEnding: true,
      outcome: "You lived to 71 in your coastal village, dying peacefully of old age. You married a local merchant, had four children, and lived a life of modest comfort. You were respected in your community as a teacher and translator, but no one knew your connection to Cortés's conquest until after your death. Your children found your journal—you'd kept one all along, recording not just your time with Cortés but your reasons for leaving and your life after. Published in 1565, it became an important document about conscience and choice. You proved that walking away is sometimes the bravest choice. You didn't stop conquest, but you refused to enable it. That's its own form of resistance. You died having helped more through teaching than you ever could have through translating for conquistadors."
    },
    ...
    fight_spanish: {
      ...
      isEnding: true,
      outcome: "You died in August 1521 during the final Spanish assault on Tenochtitlan. You were 27, killed by Spanish artillery. Your body was never identified by Spanish forces. Aztec chronicles record you as 'the Spanish woman who fought for us,' though they didn't record your name. Centuries later, historians pieced together your identity from Spanish records noting your disappearance and Aztec accounts of a Spanish woman warrior. You chose violence to resist violence. Historical debate continues about whether your choice was justified or whether you just added to the bloodshed. You proved that even conquistadors could question their side enough to switch allegiances completely. That's rare in any era. You died young, fighting for a cause that ultimately lost, but you died
